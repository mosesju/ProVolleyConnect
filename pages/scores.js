...
<p className="lead">The Polish League kept up its regular season play this week, seeing a dramatic 5-set match between AZS Olszytn and GKS Katowice (<a className={ archiveStyles.archiveLink } href="https://portal.volleymetrics.hudl.com/#/portal/match/268223" rel="noopener noreferrer"  target="_blank">VolleyMetrics</a>, <a className={ archiveStyles.archiveLink } href="https://www.youtube.com/watch?v=ZL8V8Twrtu0" rel="noopener noreferrer"  target="_blank">YouTube Highlights</a>). In the win for AZS Olszytn, TJ DeFalco scored a match high 25 points while Taylor Averill went a flawless 7 for 7 in attack. This result leaves both squads still in the middle of the Polish standings. Dustin Watten&apos;s LUK Lublin had a 3-0 sweep of Prjoekt Warszawa (Warsaw) in an upset (<a className={ archiveStyles.archiveLink } href="https://portal.volleymetrics.hudl.com/#/portal/match/268220" rel="noopener noreferrer"  target="_blank">VolleyMetrics</a>, <a className={ archiveStyles.archiveLink } href="https://www.youtube.com/watch?v=ZV_tTqvtJD4" rel="noopener noreferrer"  target="_blank">YouTube Highlights</a>), Watten passing a lights-out 50% perfect reception at the libero position. Erik Shoji and David Smith saw no action this week with Zaksa due to their current schedule of Champion&apos;s League.</p>
<p className="lead"><br/></p>
<table border="0" cellPadding="0" cellSpacing="0"  width="100%">
    <tbody>
        <tr>
...
<p className="lead">The SuperLega kept up it&apos;s high standard of play as per usual this week, though some matches were missed due to the Champion&apos;s League schedule. Padova came back against Taranto after coming back from down two, only to fall 12-15 in the 5th, maintaining their standing (<a className={ archiveStyles.archiveLink } href="https://portal.volleymetrics.hudl.com/#/portal/match/251920" rel="noopener noreferrer"  target="_blank">VolleyMetrics</a>, <a className={ archiveStyles.archiveLink } href="https://www.youtube.com/watch?v=ltKgOpC4V0k" rel="noopener noreferrer"  target="_blank">YouTube Highlights</a>). Thomas Jaeschke and his team, Allianz Milano, fell to Matt Anderson and the insanely talented, top-ranked Perugia in four sets. Both USA standouts had solid performances, with Jaeschke scoring 14 for Milano and Anderson scoring 20 for Perugia (<a className={ archiveStyles.archiveLink } href="https://portal.volleymetrics.hudl.com/#/portal/match/251915" rel="noopener noreferrer"  target="_blank">VolleyMetrics</a>, <a className={ archiveStyles.archiveLink } href="https://www.youtube.com/watch?v=9pXHiNfA4XM" rel="noopener noreferrer"  target="_blank">YouTube Highlights</a>). Trentino edged out Monza 3-1 with some stellar passing numbers. Though no featured American players, Vibo Valentia squared off against RCM Ravenna and took the match again 3-1. This was a great libero duel, with both teams passing the ball at a crazy high level.</p>
<h1 >Bundesliga</h1>
<p className="lead"><br/></p>
<table border="0" cellPadding="0" cellSpacing="0"  width="100%">
    <tbody>
